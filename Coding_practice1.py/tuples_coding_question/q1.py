...
def sum_product(input_tuple):
    # TODO
    pro=1
    summ = sum(input_tuple)
    for i in range(len(input_tuple)):
        pro=pro*int(input_tuple[i])
    return summ, pro



#Soution with explanation in course 
...
sum_result = 0 - Initialize a variable "sum_result" to store the sum of the elements in the tuple.
Set its initial value to 0.

product_result = 1 - Initialize a variable "product_result" to store the product of the elements in the tuple.
...
return sum_result, product_result - After the loop is done, return a tuple containing
the "sum_result" and "product_result".'''
...
The overall space complexity is O(1) because the function uses a constant amount of additional memory
to store the sum and product, regardless of the size of the input tuple.'''